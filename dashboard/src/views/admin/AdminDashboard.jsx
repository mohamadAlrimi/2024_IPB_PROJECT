    ...
    <div className="px-2 md:px-7 py-5">
      ...
      <div className="w-full flex flex-wrap mt-7">
        ...
        <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
          <div className="w-full bg-[#000000]   p-4 rounded-md text-white ">
            ...
            <div className="flex flex-col gap-2 pt-6 text-white ">
              <ol className="relative border-1 border-text ml-4">
                {recentMessage.map((m, i) => (
                  <li className="mb-3 ml-6">
                    ...
                    <div className="p-3 bg-slate-800 rounded-lg border border-text shadow-sm">
