    ...
    return (
      <div className="px-2 md:px-7 py-5">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-3 pb-4">
          <div className="bg-[#000000]   text-white  rounded-md p-5">
              ...
              <form onSubmit={sendRequest}>
                <div className="flex gap-3 flex-wrap">
                  <input
                    ...
                    min="0"
                    type="number"
                    className="px-3 md:w-[79%] py-2 focus:border-indigo-500 outline-none bg-[#000000]  border border-slate-700 rounded-md text-white "
                    name="amount"
                  />
                  <button
                    disabled={loader}
