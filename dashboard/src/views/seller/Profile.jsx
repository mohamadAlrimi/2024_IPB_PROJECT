        ...
        <div className="w-full flex flex-wrap">
              ...
              <div className="flex justify-center items-center py-3">
                {userInfo?.image ? (
                  <label
                    ...
                    />
                    {loader && (
                      <div className="bg-text absolute left-0 top-0 w-full h-full opacity-70 flex justify-center items-center z-20">
                        <span>
                          <FadeLoader />
                        </span>
                      </div>
                  ...
                  <form onSubmit={add}>
                    <div className="flex flex-col w-full gap-1 mb-3">
                      ...
                      <input
                        ...
                        className="px-4 py-2 focus:border-indigo-500 outline-none bg-[#000000]  border border-slate-700 rounded-md text-white "
                        type="text"
          ...
          <div className="w-full md:w-6/12">
            <div className="w-full pl-0 md:pl-7 mt-6 md:mt-0  ">
              <div className="bg-[#000000]  rounded-md text-white  p-4">
