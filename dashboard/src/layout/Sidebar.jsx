          ...
          <ul>
            {allNav.map((n, i) => (
              <li key={i}>
                <Link
                  ...
                  className={`${
                    pathname === n.path
                      ? "bg-text shadow-indigo-500/30 text-white duration-500 "
            ...
            <li>
              <button
                ...
                className="text-white font-normal duration-200 px-[12px] py-[9px] rounded-sm flex justify-start items-center gap-[12px] hover:pl-4 transition-all w-full mb-1 ">
                <span>
                  <BiLogInCircle />
                </span>
                <span>Logout</span>
