      ...
      <div className="flex gap-10 md:flex-col">
        <div className="flex flex-col gap-2 justify-start items-start py-4">
          <div>
            ...
            <span className="text-3xl font-semibold text-text">/5</span>
          </div>
          <div className="flex text-4xl">
            <Ratings ratings={product.rating} />
          </div>
          <p className="text-sm text-text">{totalReview} Reviews</p>
        </div>
        <div className="flex gap-2 flex-col py-4">
          <div className="flex justify-start items-center gap-5">
            ...
            <p className="text-sm text-text w-[0%]">{rating_review[0]?.sum}</p>
          </div>
          <div className="flex justify-start items-center gap-5">
            <div className="text-md flex gap-1 w-[93px]">
              <RatingTemp rating={4} />
            ...
            <p className="text-sm text-text w-[0%]">{rating_review[1]?.sum}</p>
          </div>
          <div className="flex justify-start items-center gap-5">
            <div className="text-md flex gap-1 w-[93px]">
              <RatingTemp rating={3} />
            ...
            <p className="text-sm text-text w-[0%]">{rating_review[2]?.sum}</p>
          </div>
          <div className="flex justify-start items-center gap-5">
            <div className="text-md flex gap-1 w-[93px]">
              <RatingTemp rating={2} />
            ...
            <p className="text-sm text-text w-[0%]">{rating_review[3]?.sum}</p>
          </div>
          <div className="flex justify-start items-center gap-5">
            <div className="text-md flex gap-1 w-[93px]">
              <RatingTemp rating={1} />
            ...
            <p className="text-sm text-text w-[0%]">{rating_review[4]?.sum}</p>
          </div>
          <div className="flex justify-start items-center gap-5">
            <div className="text-md flex gap-1 w-[93px]">
              <RatingTemp rating={0} />
            ...
            <p className="text-sm text-text w-[0%]">0</p>
          </div>
        </div>
      </div>
      <h2 className="text-text text-xl font-bold py-5">
      ...
      <div className="flex flex-col gap-8 pb-10 pt-4">
        {reviews.map((r, i) => (
          <div key={i} className="flex flex-col gap-1">
            ...
            <span className="text-text text-md">{r.name}</span>
            <p className="text-text text-sm">{r.review}</p>
          </div>
        ))}
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-1">
              <RatingReact
                ...
                initialRating={rat}
                emptySymbol={
                  <span className="text-text text-4xl">
                    <CiStar />
                  </span>
                }
                fullSymbol={
