...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    dispatch(
      add_friend({
        sellerId: "666446bd3834e0c99738e646" || "",
        userId: userInfo.id,
      })
    );
  }, [sellerId]);
    ...
    <div className="bg-black p-3 rounded-md">
      <div className="w-full flex relative">
        <div
          ...
          <div className="flex justify-center gap-3 items-center text-black text-xl h-[50px]">
            <span>
              <AiOutlineMessage />
            </span>
            <span>Message</span>
          </div>
          <div className="w-full flex flex-col text-text py-4 h-[400px] pr-3">
            {my_friends.map((f, i) => (
              <Link
                to={`/chat/${f.fdId}`}
                key={i}
                ...
                <span className="text-black">{f.name} SELLER RIMI</span>
              </Link>
            ))}
          </div>
        </div>
        <div className="w-[calc(100%-230px)] md-lg:w-full">
          {currentFd ? (
            <div className="w-full h-full">
              <div className="flex justify-between items-center text-text text-xl h-[50px]">
              ...
              <div className="flex p-2 justify-between items-center w-full">
                ...
                <div className="w-[40px] bg-white p-2 justify-center items-center rounded-full">
            ...
            <div
              ...
              className="w-full flex justify-center items-center text-lg ont-bold text-[#000] h-[400px]">
