            ...
            <div className="w-full flex flex-wrap">
              <div
                ...
                <div className="py-2 flex flex-col gap-5">
                  <h2 className="text-3xl font-bold mb-3 text-text">Price</h2>
                  <Range
                    step={5}
                    min={priceRange.low}
                    max={priceRange.high}
                ...
                <div className="py-3 flex flex-col gap-4">
                  <h2 className="text-3xl font-bold mb-3 text-text">Rating</h2>
                  ...
                  <div className="py-4 bg-white mb-10 px-3 rounded-md flex justify-between items-start border">
                    ...
                    <div className="flex justify-center items-center gap-3">
                      <select
                        ...
                        className="p-1 border outline-0 text-text font-semibold"
                        name=""
                        id="">
                      ...
                      <div className="flex justify-center items-start gap-4 md-lg:hidden">
                        <div
                          ...
                          } text-text hover:bg-slate-300 cursor-pointer rounded-sm`}>
                          <BsFillGridFill />
                        </div>
                        <div
