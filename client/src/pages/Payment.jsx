            ...
            <div className="flex flex-wrap md:flex-col-reverse">
                    ...
                    <div
                      ...
                      <div className="flex flex-col gap-[3px] justify-center items-center">
                        <img
                          ...
                          alt="stripe"
                        />
                        <span className="text-text">Stripe</span>
                      </div>
                    </div>
                    <div
                    ...
                    <div
                      ...
                      <div className="flex flex-col gap-[3px] justify-center items-center">
                        <img
                          ...
                          alt="nogot"
                        />
                        <span className="text-text">Nogot</span>
                      </div>
                    </div>
                    <div
                      ...
                      <div className="flex flex-col gap-[3px] justify-center items-center">
                        <img
                          ...
                          alt="roket"
                        />
                        <span className="text-text">Roket</span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="w-5/12 md:w-full">
                <div className="pl-2 md:pl-0 md:mb-0">
                  <div className="bg-white shadow p-5 text-text flex flex-col gap-3">
                    <h2>Order Summary</h2>
