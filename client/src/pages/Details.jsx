    ...
    return (
      <div>
        ...
        <div className="bg-slate-100 py-5 mb-5">
          <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
            <div className="flex justify-start items-center text-md text-text w-full">
              <Link to="/">Home</Link>
              <span className="pt-1">
            ...
            <div className="flex flex-wrap">
                ...
                <div className="pr-4 md-lg:pr-0">
                  ...
                  <div>
                    {state === "reviews" ? (
                      ...
                      <p className="py-5 text-text">{product.description}</p>
                    )}
                  </div>
                </div>
              </div>
              <div className="w-[28%] md-lg:w-full">
                <div className="pl-4 md-lg:pl-0">
                  <div className="px-3 py-2 text-text bg-slate-200">
                    ...
                    {moreProducts.map((p, i) => {
                      return (
                        <Link className="block">
                          ...
                          <h2 className="text-text py-1">{p.name}</h2>
        ...
        <section>
          <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
            <h2 className="text-2xl py-8 text-text">Related Products</h2>
            <div>
              <Swiper
                slidesPerView="auto"
                breakpoints={{
